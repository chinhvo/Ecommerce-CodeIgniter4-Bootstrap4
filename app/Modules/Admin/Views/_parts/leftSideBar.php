...
<div class="col-12 col-sm-3 col-lg-2 bg-light border-right left-side">
    ...
    <ul class="list-unstyled sidebar-menu">
        ...
        <li>
            <a href="<?= base_url('admin/publish') ?>" class="<?= urldecode(uri_string()) == 'admin/publish' ? 'active font-weight-bold' : '' ?>">
        ...
        <li>
            <a href="<?= base_url('admin/blogpublish') ?>" class="<?= urldecode(uri_string()) == 'admin/blogpublish' ? 'active font-weight-bold' : '' ?>">
