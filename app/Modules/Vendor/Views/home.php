<?php if ($this->session->getFlashdata('update_vend_err')) { ?>
    <div class="alert alert-danger"><?= implode('<br>', $this->session->getFlashdata('update_vend_err')) ?></div>
<?php } ?>
<?php if ($this->session->getFlashdata('update_vend_details')) { ?>
