<div class="auth-page">
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4"> 
            <?php
            if ($this->session->getFlashdata('error_register')) {
                ?>
                <div class="alert alert-danger"><?= implode('<br>', $this->session->getFlashdata('error_register')) ?></div>
                <?php
            }
            ?>
            <div class="vendor-login">
                ...
                <form method="POST" action="">
                    <input type="text" name="u_email" value="<?= $this->session->getFlashdata('email') ? $this->session->getFlashdata('email') : '' ?>" placeholder="<?= lang('email') ?>">
