...
class Users extends MyController
{
    ...
    public function login()
    {
        if (isset($_POST['login'])) {
            ...
            if ($result !== false) {
                ...
                $this->session->setFlashdata('userError', lang('wrong_user'));
            }
        }
        $head = array();
        $data = array();
    ...
    public function register()
    {
        if (isset($_POST['signup'])) {
            ...
            if ($result == false) {
                $this->session->setFlashdata('userError', $this->registerErrors);
    ...
    public function myaccount($page = 0)
    {
        ...
        $data['links_pagination'] = pagination('myaccount', $rowscount, $this->num_rows, $page, 2);
