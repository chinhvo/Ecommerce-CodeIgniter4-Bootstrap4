<header class="header row">
    <?php if (!empty($multiVendor) && $multiVendor == 1): ?>
        <div id="top-user-panel" class="container">
    ...
    <?php endif; ?>
    <div id="menuHeader" class="menu-header-row d-flex align-items-center w-100">
        <div class="col-12 col-md-3 logo-col d-flex align-items-center px-0">
        ...
        <div class="col-12 col-md-5 search-box">
            <?php
            ...
            <form method="GET" id="bigger-search" class="search" action="<?= LANG_URL ?>">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        ...
                        <button id="clear-search-btn" class="btn btn-light clear-button-btn" onclick="clearForm()" type="button" title="Clear search" aria-label="Clear search" style="<?= isset($_GET['search_in_title']) && trim((string) $_GET['search_in_title']) !== '' ? '' : 'display:none;' ?>">
        ...
        <div class="col-12 col-md-2 header-hotline">
            <a href="tel:18006726">
