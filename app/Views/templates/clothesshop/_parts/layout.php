...
<body>
	<div id="wrapper">
		<div id="content">
		    <?= $this->include('templates/clothesshop/_parts/header') ?>		
			<div class="container-fluid">
				<div class="row">
					<?= $this->include('templates/clothesshop/_parts/topMenu') ?>
            		 <?php if (strpos(uri_string(), "home") || strpos(uri_string(), "")) { ?>
		...
		<?= $this->include('templates/clothesshop/_parts/footer') ?>			
	</div> 
