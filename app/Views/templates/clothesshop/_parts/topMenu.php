<?php if (session()->get('logged_in')) { ?>
    ...
    <div class="col-12 col-sm-3 col-lg-2 bg-light border-right left-side">
        ...
        <ul class="list-unstyled sidebar-menu">
            ...
            <li>
                <a
                    href="<?= base_url('admin/publish') ?>"
                    class="<?= urldecode(uri_string()) == 'admin/publish' ? 'active font-weight-bold' : '' ?>"
                >
                    <i class="fa fa-edit"></i> <?= lang('publish_product') ?>
                </a>
            </li>
            <li>
                <a
            ...
            <li>
                <a
                    href="<?= base_url('admin/shopcategories') ?>"
            ...
            <?php if (in_array('blog', $activePages)) { ?>
                ...
                <li>
                    <a
                        href="<?= base_url('admin/blogpublish') ?>"
                        class="<?= urldecode(uri_string()) == 'admin/blogpublish' ? 'active font-weight-bold' : '' ?>"
                    >
                        <i class="fa fa-edit"></i> <?= lang('publish_post') ?>
                    </a>
                </li>
                <li>
                    <a
            ...
            <li>
                <a
                    href="<?= base_url('admin/filemanager') ?>"
            ...
            <li>
                <a
                    href="<?= base_url('admin/adminusers') ?>"
            ...
            <li>
                <a
                    href="<?= base_url('admin/listvendors') ?>"
