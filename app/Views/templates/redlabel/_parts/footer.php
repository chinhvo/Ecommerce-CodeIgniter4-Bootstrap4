<a href="#" class="scrolldown" title="Go down page"><i class="fa fa-angle-down active"></i></a>
                ...
                <div class="col-lg-2  col-md-2 col-sm-4 col-xs-6 f-col">
                    ...
                    <ul class="footer-icon">
                        ...
                        <?php }if ($footerContactPhone != '') { ?>
                            <li>                                
                                <a href="http://zalo.me/<?= $footerContactPhone ?>" class="nav-top-link" target="_blank">
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="pull-left">
                ...
                Ref <a href="https://github.com/kirilkirkov">Kiril Kirkov</a>
            </p>
