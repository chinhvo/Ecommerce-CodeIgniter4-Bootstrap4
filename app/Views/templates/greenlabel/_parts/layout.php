...
<html lang="<?= MY_LANGUAGE_ABBR ?>">
    ...
    <body>
        ...
        <?= $this->include('templates/greenlabel/_parts/header') ?>
        <?= $this->include('templates/greenlabel/_parts/topMenu') ?>
        <?= $this->renderSection('content') ?>
        <?= $this->include('templates/greenlabel/_parts/footer') ?>
        ...
        echo $addJs ?? '';
        if (session()->getFlashdata('userError')) {
            if (is_array(session()->getFlashdata('userError'))) {
                $usr_err = implode(' ', session()->getFlashdata('userError'));
            } else {
                $usr_err = session()->getFlashdata('userError');
            }
            ?>
            <script>
                $(document).ready(function () {
