...
class Rest extends BaseConfig
{
    ...
    public  bool $strict_api_and_auth = TRUE; // force the use of both api and auth before a valid api request is made
    ...
    /*
     ...
     |
     */
    public  string $auth_library_class = '';
    public  string $auth_library_function = '';
    ...
    /*
     ...
     |
     */
    public  array $rest_valid_logins = [
        'default' => array(
            'admin' => '1234'
        )    
    ];
